...
$Cliente = $sentencia->fetch(PDO::FETCH_OBJ);
        ...
        "app" => [
            ...
            "data" => [
                ...
                "message" => [[
                    "time" => '1654728819',
                    "type" => 'text',
                    "value" => 'Estimado(a) *'.strtoupper($Cliente->Nombre).'* recuerde que tiene hasta *'.strtoupper($Cliente->Devolucion).'* para devolver el vehiculo '
                ]]
            ]
        ]
    ];
    ...
    header('Location: registro.php?codigo='.$Cliente->id_Cliente);
?>
